...
grid_search = GridSearchCV(estimator=random_forest_model, param_grid=param_grid, cv=5, scoring='neg_mean_absolute_error')
...
best_random_forest_model.fit(input_train, output_train)

# Make predictions on the test set
output_pred_random_forest = best_random_forest_model.predict(input_test)
