...
grid_search.fit(input_train, output_train.ravel())
...
output_pred_svr = best_svr_model.predict(input_test)

# Calculate Mean Absolute Error (MAE) loss and R2 score
mae_loss_svr = mean_absolute_error(output_test, output_pred_svr)
r2_svr = r2_score(output_test, output_pred_svr)

print("Best SVR Model Hyperparameters:", best_params)
print("Best SVR Mean Absolute Error (MAE):", mae_loss_svr)
print("Best SVR R2 Score:", r2_svr)