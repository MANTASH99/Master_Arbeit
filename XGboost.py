...
# Train the model
gbr.fit(input_train, output_train)
gbr_predictions = gbr.predict(input_test)
mae = mean_absolute_error(output_test, gbr_predictions)
r2 = r2_score(output_test, gbr_predictions)
