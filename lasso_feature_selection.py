...
if has_nan:
    ...
    # Create lists to store selected and canceled features
    selected_features = []
    canceled_features = []

    # Identify selected and canceled features
    for feature, coef in zip(feature_names, coefficients):
        if coef != 0:
            selected_features.append(feature)
        else:
            canceled_features.append(feature)

    # Print selected and canceled features
    print("Selected Features:", selected_features)
    print("Canceled Features:", canceled_features)
    ...
    plt.scatter(output_test, lasso_predictions, c='red', label='Actual vs. Predicted')
